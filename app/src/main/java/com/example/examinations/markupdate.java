...
public class markupdate extends AppCompatActivity {
    ...
    private void fetchStudentFullName() {
        databaseReference.child("Students").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                ArrayAdapter<String> studentAdapter = new ArrayAdapter<>(markupdate.this, android.R.layout.simple_spinner_item, fullNames);
        ...
        databaseReference.child("Students").child(selectedRegistrationNumber).child("Courses")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        ArrayAdapter<String> courseAdapter = new ArrayAdapter<>(markupdate.this, android.R.layout.simple_spinner_item, courses);
                        courseAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                        lecCourseSpinner.setAdapter(courseAdapter);
                    }
    ...
    private void submitMarks() {
        ...
        databaseReference.child("Students").child(selectedRegistrationNumber).child("Courses").child(selectedCourse).child("Marks")
                ...
                .addOnSuccessListener(aVoid -> {
                    ...
                    Intent intent = new Intent(markupdate.this, markinput.class);
    ...
    private void showToast(String message) {
        handler.post(() -> Toast.makeText(markupdate.this, message, Toast.LENGTH_SHORT).show());
    }
}